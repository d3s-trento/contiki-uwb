...
Weaver exploits SAMU to build a synchronised flood where the sink
is the time reference.  
The code for SAMU can be found at [contiki-uwb/dev/dw1000/samu/](../../dev/dw1000/samu).

Energy information is managed by the Statetime module, which
is embedded in SAMU. The source code of Statetime can be
