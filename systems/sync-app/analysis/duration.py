...
p = subprocess.Popen(['get_duration.sh', f'{args.job_id}'], stdout=subprocess.PIPE)
...
dd['duration_ms'] = dd['duration_us'] / 1000

print(dd.describe())

sns.scatterplot(x='epoch', y='duration_ms', hue='node_id', 
                   data=dd,
                   palette='viridis', s=5)
