...
#define CRYSTAL_CONF_PERIOD ((uint32_t)CRYSTAL_CONF_PERIOD_MS * 1000)
#endif

#ifndef CRYSTAL_CONF_PERIOD
#define CRYSTAL_CONF_PERIOD ((uint32_t)1000 * 1000)
#endif
...
// #define CRYSTAL_CONF_DUR_S ((uint32_t) ((double)
// RTIMER_SECOND*CRYSTAL_CONF_DUR_S_MS/1000) ) #endif
//
...
// #define CRYSTAL_CONF_DUR_T ((uint32_t) ((double)
// RTIMER_SECOND*CRYSTAL_CONF_DUR_T_MS/1000) ) #endif
//
...
// #define CRYSTAL_CONF_DUR_A ((uint32_t) ((double)
// RTIMER_SECOND*CRYSTAL_CONF_DUR_A_MS/1000) ) #endif
//
...
// the number of Ts with reception errors in a row for the sink to send the
// sleep command zero means that the reception error detection feature during T
// slots is disabled
...
#define N_SILENT_EPOCHS_TO_STOP_SENDING 2
